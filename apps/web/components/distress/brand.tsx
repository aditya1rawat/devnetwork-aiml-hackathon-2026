...
const NAV_ITEMS = ["Overview", "Pipelines", "Connections", "Deploys", "Settings"];
  ...
  return (
    <div className="ridgeline-shell">
      ...
      <nav className="ridgeline-nav">
        <a href="#" className="ridgeline-wordmark" aria-label="Ridgeline">
      ...
      <div className="ridgeline-status">
        <span className="ridgeline-status-dot" aria-hidden />
        <span className="ridgeline-status-text">
          <span className="ridgeline-status-label">STATUS:&nbsp;DEGRADED</span>
